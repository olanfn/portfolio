...
const socials = [
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/in/olanfn',
    icon: (
  ...
  {
    name: 'Instagram',
    href: 'https://instagram.com/olanfn',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    name: 'Facebook',
    href: 'https://facebook.com/olanfn',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
